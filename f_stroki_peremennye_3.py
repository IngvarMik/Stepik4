...
print(f'{n:5d}')
print(f'{n:4d}')
"""Запись n:7d говорит, что  переменную n нужно представить в виде целого числа (это знак  d ) и на 
отображение всего числа выделить 7 знаков. Если у переменной n не хватает разрядов до семи, 
...
Не бойтесь, мы пройдем ее подробно чуть позже, сейчас вам нужно лишь поверхностное понимание того,
 что здесь происходит. Наша программа печатает для каждого числа от 1 до 10 значения его квадрата и куба.
